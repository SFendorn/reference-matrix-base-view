...
I maintain a long running Pen & Paper session as a dungeon master, where we create the world as we play, so lots and lots of information to keep track of. I maintain an obsidian vault with all the information about the world, as well as session logs, where I keep track of what has happened during a session.
